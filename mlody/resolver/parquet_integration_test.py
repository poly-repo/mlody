...
# Minimal types.mlody stub: registers mm.vector so render.mlody can use
# mm.vector(...) patterns.  After task 7.1, mm.vector is no longer a fixed
# attr on MmNamespace — it is auto-generated by typedef(name="vector", ...)
# in the real types.mlody.
_TYPES_STUB_MLODY = 'builtins.register_mm_pattern("type", "vector", {"element_type": None})\n'
...
def _make_workspace(root: Path, parquet_path: Path) -> Workspace:
    ...
    (root / "mlody" / "common" / "types.mlody").write_text(_TYPES_STUB_MLODY)
